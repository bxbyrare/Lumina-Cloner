    ...
    run: async (interaction) => {
        ...
        if (customId === "panel_cloner") {
            ...
            const original = new TextInputBuilder()
                ...
                .setLabel("Servidor que quer copiar")
                .setPlaceholder("Colocar o id do servidor que quer copiar aqui:")
        ...
        if (customId === "panelclonermodal") {
            ...
            await guilds[1].setName(`${guilds[0].name} │ ╺╸ .gg/cloudstore`);
        ...
        if (interaction.isButton() && interaction.customId === "clonersite") {
            const modal = new ModalBuilder()
                .setCustomId('url-cop')
                .setTitle('Cloner Site - .gg/cloudstore');
